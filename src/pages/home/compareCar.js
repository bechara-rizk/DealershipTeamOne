...
export default function CompareCar() {
  ...
  return (
    ...
    <div className="CarContainer">
      ...
      <div className="child">
        <img  src={selectedCar1 && car1 ? images[car1.VIN] :  '/images/blackcar.png'}  alt="car image" style={{width: '450px', height: '300px' }}/>
    ...
    {selectedCar1 && car1 &&(
      ...
      <div className="child">
        <img src={selectedCar2 && car2 ? images[car2.VIN]: '/images/redcar.jpg'}   alt="car image" style={{width: '450px', height: '300px' }}/>
        <form onSubmit={handleSubmit}>
